...
import { Operation, RefreshRight, Search, StarFilled } from '@element-plus/icons-vue'
...
const { columns, allColumns, toggleColumn, persistColumns, hasPendingChanges, onResizeStart } = useColumnConfig()
...
.candidates-table :deep(.row-high-priority td) {
  background-color: var(--row-highlight-high) !important;
}

.candidates-table :deep(.row-medium-priority td) {
  background-color: var(--row-highlight-medium) !important;
}
