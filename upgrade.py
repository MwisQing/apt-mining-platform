...
def db_env() -> tuple:
    """Return (user, password) for database from .env."""
    load_dotenv()
    return (
        os.environ.get("APT_DB_USER", "apt_test"),
        os.environ.get("APT_DB_PASSWORD", ""),
    )
...
def backup_database() -> str:
    ...
    backup_path = backups_dir / f"{db_name}_{timestamp}.sql"
